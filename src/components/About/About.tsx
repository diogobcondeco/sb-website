...
const About = () => {
  return (
    <div className='w-screen flex flex-col justify-center items-center py-12'>
      ...
      <div className='w-[67rem] flex justify-center gap-x-8'>
        <AboutCard title={'MISSÃO'} description={'Ajudar o próximo a ressignificar o passado, atingir o seu estado desejado no futuro e a ser FELIZ.'} />
        <AboutCard title={'VISÃO'} description={'Ser feliz e realizada ao ajudar outras pessoas.'} />
        <AboutCard title={'VALORES'} description={'Preza pela flexibilidade no atendimento, respeitando sempre o mapa mental do cliente. A realização ao motivar pessoas a viver com mais qualidade de pensamentos, emoções e sentimentos é o fator mais importante.'} />
      </div>
    </div>
  )
};
